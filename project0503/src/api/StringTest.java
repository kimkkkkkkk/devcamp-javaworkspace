...
class StringTest{
	public static void main(String[] args){
		...
		//string 클래스의 api document를 이용하여, 개발자는 여러 기능들을 참조할 수 있다...

		//문자열의 길이를 알 수 있는 api 기능
		System.out.println("문자열의 길이는 "+s.length());
		
		//대문자로 변환하는 메서드 api문서 기능
		System.out.println(s.toUpperCase());
	}

		//두번째 p의 index를 반환하는 api 문서 링크
		//System.out.println("마지막 p의 index는 "+s.lastIndexOf("p"));

		//원하는 번째에 있는 문자 1개를 추출하는 api
