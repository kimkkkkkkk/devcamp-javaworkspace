...
public class ChatServer extends JFrame {
	...
	/*쓰레드 구현의 3가지 방법
	 * 1. 별도의 .java 파일로 생성( 재사용성 높을때, 관리 목적상 코드를 분리시키고 싶을때
	 * 2. 내부 익명으로 가는 법
	...
	//이 백터를 통해, 접속자의 수, ServerMsgThread의 주소값을 이용한 제어 등이 가능 (고정시킴)
	public ChatServer() {
		//생성 
		p_north = new JPanel();
