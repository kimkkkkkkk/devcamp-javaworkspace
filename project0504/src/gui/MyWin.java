...
public class MyWin{
	...
	public static void main(String[] args){
		...
		/*Frame 이라는 클래스는 쓰라고 제공해준 것인데, 문제는 어떻게 사용해야할지 난감함..
		왜?? 우리가 정의한 클래스가 아니므로.. 즉 남이 제공해준것이므로..
		 [남에게 제공받은 객체 사용하는 Tip]
				1) 해당 클래스가 도대체 뭔지? 용도가 뭔지? 사용목적이 뭔데?
				...
				//윈도우 안에 부착할 버튼 생성
				Button bt = new Button("me"); // Button is a Component!!

				//버튼 부착후, 대왕버튼이 나오는 이유?
				//모든 gui 프로그래밍 에서는 화면의 배치 방법을 개발자가 결정해야 한다..
				...
				//입력텍스트 박스 생성하여 붙여보자!!
				TextField t = new TextField(20); // 20자만 넣을 수 있다는 뜻이 아니라, 20자 크기의 너비가 확보됨
				//체크 박스 생성하여 붙여보자!!
				...
				//html 의 select 박스는 java에서는 Choice라고 한다
				...
				//따라서 개발자가 원하는 타임에, 눈에 보일 수 이도록 속성을 변경하는 메서드를 호출해보자!!
